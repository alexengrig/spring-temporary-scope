...
public class SpringTemporaryScopeProvider implements Scope {
    ...
    private final Map<String, Runnable> callbackByName = new ConcurrentHashMap<>();

    @Override
    public Object get(String name, ObjectFactory<?> objectFactory) {
        return scopeProvider.get(name, objectFactory::getObject);
    }

    @Override
    public Object remove(String name) {
        Object object = scopeProvider.remove(name);
